...
export default function AppointmentForm() {
  const [formData, setFormData] = useState({
    ...
    date: "",
    time: "",
    location: "Musky Slow Bar & Bakery (offline)",
    type: "Ring",
    message: "",
  });
    ...
    <main className="w-full relative min-h-screen bg-[var(--bg)] flex flex-col selection:bg-[var(--accent)] selection:text-black overflow-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <Image
          ...
          alt="Handcrafted spoon ring workshop by 2Q Nhẫn Thuật"
          fill
        ...
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4 font-body text-base sm:text-lg leading-relaxed text-[var(--text-muted)] border-l-[3px] border-[var(--accent)] pl-6 mb-12">
              <p>
                Transforming vintage spoons into unique jewelry. Each handcrafted piece is meticulously crafted to your style, carrying a story of its own.
              </p>
            </div>

            <div className="mt-4">
              <h2 className="font-display text-xl text-[var(--text-primary)] mb-6 tracking-wide">Estimated Crafting Time</h2>
            ...
            <div className="backdrop-blur-xl bg-[var(--bg-elevated)]/40 border border-[rgba(240,237,232,0.1)] p-8 sm:p-12 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.5)]">
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2 mt-2">
                  <label htmlFor="location" className="font-body text-[10px] uppercase tracking-[0.15em] text-[var(--text-muted)] ml-1">Location</label>
                  <select
                    id="location"
                    name="location"
                    ...
                    required
                  >
                    <option value="Musky Slow Bar & Bakery (offline)" className="bg-[var(--bg-elevated)] text-[var(--text-primary)]">Musky Slow Bar & Bakery (offline)</option>
                    <option value="Innoir (offline)" className="bg-[var(--bg-elevated)] text-[var(--text-primary)]">Innoir (offline)</option>
                    <option value="Online appointment" className="bg-[var(--bg-elevated)] text-[var(--text-primary)]">Online appointment</option>
                  </select>
                </div>
